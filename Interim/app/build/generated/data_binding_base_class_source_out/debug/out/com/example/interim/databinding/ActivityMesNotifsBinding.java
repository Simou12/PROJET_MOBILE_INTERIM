...
public final class ActivityMesNotifsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityMesNotifsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMesNotifsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_mes_notifs, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMesNotifsBinding bind(@NonNull View rootView) {
