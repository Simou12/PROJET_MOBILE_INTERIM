...
public final class ActivityProfilGestionnaireBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityProfilGestionnaireBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityProfilGestionnaireBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityProfilGestionnaireBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_profil_gestionnaire, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityProfilGestionnaireBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProfilGestionnaireBinding((ConstraintLayout) rootView, ajoutOffreEmp,
