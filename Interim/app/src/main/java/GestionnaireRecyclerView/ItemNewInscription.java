...
public class ItemNewInscription {
    ...
    public ItemNewInscription(String nom,String role, String adresse, String email, String tel, String numNational, String departement, String sDeparement, String dateInscription, int accepterbtn, int refuserbtn, int date, int local, int gmail, int phone) {
        this.nom = nom;
