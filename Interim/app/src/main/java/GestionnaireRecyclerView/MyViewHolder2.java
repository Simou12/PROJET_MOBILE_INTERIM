...
public class MyViewHolder2 extends RecyclerView.ViewHolder{
    ...
    TextView aucune,nameView,roleView,emailView,telView,numNationalView,departementView,sDepartementView,dateInscription;
    ...
    public MyViewHolder2(@NonNull View itemView) {
        ...
        aucune = itemView.findViewById(R.id.aucune);
