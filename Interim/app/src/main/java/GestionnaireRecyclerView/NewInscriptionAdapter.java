...
import com.example.interim.Item;
...
CardView cardView;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder2 holder, int position) {
        ...
        holder.imageView1.setImageResource(items.get(position).getDate());
        ...
        holder.btnAccepter.setText(items.get(position).getAccepterbtn());
        holder.btnRefuser.setText(items.get(position).getRefuserbtn());
