...
public class GererEmployeurProfil extends Drawer_base {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        employeurRef = FirebaseDatabase.getInstance().getReference().child("employeur");
        employeurRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot interimairSnap : snapshot.getChildren()){
                    Employeur candidat = interimairSnap.getValue(Employeur.class);
                        ...
                        personRef.updateChildren(updates)
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(GererEmployeurProfil.this, "Mise à jour échouée!", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                }
