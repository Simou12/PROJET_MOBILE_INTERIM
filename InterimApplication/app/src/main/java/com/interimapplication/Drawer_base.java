...
import com.interimapplication.Accueil;
import com.interimapplication.CurrentUserManager;
import com.interimapplication.MainActivity;
import com.interimapplication.Profil;
import com.interimapplication.ProfilEmployeur;
            ...
            case R.id.profil :
                ...
                employeeRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(employeeExist){
                            startActivity(new Intent(Drawer_base.this, ProfilEmployeur.class));
                            overridePendingTransition(0,0);
                        }else{
                            ...
                            interimaireRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    if(interimaireExist){
                                        startActivity(new Intent(Drawer_base.this, Profil.class));
                                        overridePendingTransition(0,0);
                                    }
                                }
                                @Override
